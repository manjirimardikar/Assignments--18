...
function Login() {
    ...
    console.log(user)
  return (
    <div style={{width:"500px",textAlign:"center",padding:'40px', margin:"250px auto",boxShadow: "rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px",color:"wheat"}}>
        ...
        onClick={()=>{
            console.log("hello")
            if((user.userName==="Manjari"&& user.pass==="1234") ||(user.userName==='admin'&& user.pass==="admin")){
                setislogin(true)
